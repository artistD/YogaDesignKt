...
class MovieItem(var rank : String, var title : String, var openMovie:String, var audiSum : String, var imgUrl : String, var subTitle:String, var director:String, var actor:String, var userRationg :String){
